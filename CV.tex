...
\section{Experience}
	...
	\explanationdetail{%
		\begin{itemize}[label=\textcolor{red}{$\circ$}, leftmargin=*]
			...
			\item Defined requirements for and designed, simulated, and constructed a small satellite propulsion system prototype, and constructed air bearing testbed to simulate microgravity conditions for 3 Degree-of-Freedom propulsion system testing.
			...
			\item Developed Python-based propulsion simulation model to estimate time-varying performance of thrusters utilizing non-constant supply pressure, experimentally validated the simulation and presented results at AIAA SciTech 2020.
