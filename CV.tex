...
\section{Experience}
	...
	\explanationdetail{%
		\begin{itemize}[label=\textcolor{red}{$\circ$}, leftmargin=*]
			...
			\item Constructed small satellite propulsion system and air bearing testbed to simulate microgravity conditions and enable highly repeatable motion measurements at low cost, and open-sourcing the design for other organizations.
			...
			\item Designed Printed Circuit Boards (PCB) and soldered components to form the electronics package of the propulsion system controller and used multimeter testing to verify electrical connections and diagnose connection problems.
	...
	\explanationdetail{%
		\begin{itemize}[label=\textcolor{red}{$\circ$}, leftmargin=*]
			...
			\item Drew schematics for and fabricated data and power wiring harnesses for Mars 2020 motor and actuator testing
