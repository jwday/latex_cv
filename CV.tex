...
% Education
\section{Education}
    \datedexperience{M.S. Mechanical and Aerospace Engineering}{2020}\\[-0.5cm]
	\explanation{University of California, Davis}
	\explanationdetail{%
		\begin{itemize}[label=\textcolor{red}{$\circ$}, leftmargin=*]
			\item Thesis: \emph{Development of a Two-Fault Tolerant Cold Gas Propulsion System and Air Bearing Testbed for\newline Application to a Spacecraft-Inspection CubeSat}, \href{https://raw.githubusercontent.com/jwday/Thesis-Pub/master/Josh\%20Day\%2C\%20MS\%20Thesis\%20vFinal.pdf}{available online}
		\end{itemize}
    }
    \datedexperience{B.S. Mechanical Engineering}{2013}\\[-0.5cm]
...
\section{Experience}
	...
	%
    \datedexperience{Engineering Design \& Communications Teaching Assistant}{Jan 2018 -- Jun 2019} 
    % \explanation{Engineering Design \& Communications Teaching Assistant}
	\explanationdetail{%
		\begin{itemize}[label=\textcolor{red}{$\circ$}, leftmargin=*]
			\item As lead TA, assisted with lesson plan development and task delegation, and supervised three bi-weekly lab sessions consisting of 6 teams of 4 students, each with their own individual project needs.
			...
			\item Provided effective feedback to students engaged in public speaking and presentations, citing notable improvement in student communications skills from beginning to end of quarter.
		\end{itemize}
	}
    %
...
\section{Technical Skills}
	...
	\explanationdetail{\footnotesize \textsc{%
		\begin{tabular}{ r l l }
			...
			\textbf{Programming Languages}			& Python \cpshalf C++ / Arduino \cpshalf MATLAB \cpshalf JavaScript/HTML/CSS					\\
