...
\section{Experience}
	...
	\begin{itemize}[label=\textcolor{red}{$\circ$}, leftmargin=*]
			...
			\item Developed three unique concepts for launch restraint mechanism and derived motor torque and spring stiffness requirements for each.
			\item Led a 3-person team to implement one selected concept and steered the design through PDR.
			\item Analyzed and presented on contact stress and joint friction, and ensured positive force and torque margins with respect to NASA specs and safety factors.
	...
	\explanationdetail{%
		\begin{itemize}[label=\textcolor{red}{$\circ$}, leftmargin=*]
			\setlength\itemsep{-0.05em}
			\item Delivered flight hardware components by overseeing receiving inspections and vendor processes, and managed inventory to track progress and schedule.
			\item Developed procedures and performed requirements validation testing for the Europa Clipper Heat Redistribution System.
	...
	\explanationdetail{%
		\begin{itemize}[label=\textcolor{red}{$\circ$}, leftmargin=*]
			\setlength\itemsep{-0.05em}
			\item Defined requirements for and designed, simulated, and constructed a small satellite propulsion system prototype and testbed.
			...
			\item Constructed a 3 degree-of-freedom air bearing platform to simulate microgravity for propulsion system testing using COTS hardware and 3D-printed components.
	...
	\explanationdetail{%
		\begin{itemize}[label=\textcolor{orange}{$\circ$}, leftmargin=*]
			\setlength\itemsep{-0.05em}
			\vspace{-0.9em}
			\item \emph{Manufacturing Processes} \quad \textcolor{red}{$\circ$} \emph{Engineering Design \& Communications} (Lead) \quad \textcolor{red}{$\circ$} \emph{Measurement Systems}
		\end{itemize}
	}
...
\section{Technical Skills}
	...
	\explanationdetail{\footnotesize \textsc{%
		\begin{tabular}{ r l l }
			...
			\textbf{Programming/Software}			& Python \cpshalf MATLAB \cpshalf Arduino (C++) \cpshalf Linux / WSL \cpshalf Git			\\
		\end{tabular}
		}
	}
